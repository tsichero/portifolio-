...
## Sobre mim
- Experiência em Clínica Médica e Cirúrgica de pequenos animais  
- Consultoria e implementação de soluções em Inteligência Artificial  
- Criação de ferramentas para aprendizado e simulação de exames veterinários  
...
💡 **Obs:** Este portfólio está em constante evolução, com foco em inovação, educação e tecnologias aplicadas à Medicina Veterinária e IA.
